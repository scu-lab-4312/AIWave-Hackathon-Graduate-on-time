...
5. [Medical Agent：隱私最小化 AWS CLI 部署紀錄](05-medical-aws-cli-deployment.md)
6. [Taxi Agent：共享 CMS 司機與 AgentCore 部署紀錄](06-taxi-aws-cli-deployment.md)
...
- 不需要獨立長期記憶的服務可以不建立專業 Agent Memory；Medical 與 Taxi 都由 Orchestrator sticky task 傳遞必要狀態。
