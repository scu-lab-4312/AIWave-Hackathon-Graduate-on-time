...
def initialize_medical_demo_data() -> dict:
    ...
    pharmacies = [
        ...
        ("士林康健藥局", "台北市", "士林區", "台北市士林區中正路210號", 4.9, "徐佳穎藥師", "@demo-pharm-shilin-01"),
        ("天母好鄰居藥局", "台北市", "士林區", "台北市士林區天母西路35號", 4.8, "何俊廷藥師", "@demo-pharm-shilin-02"),
        ("劍潭安心藥局", "台北市", "士林區", "台北市士林區基河路88號", 4.7, "許雅婷藥師", "@demo-pharm-shilin-03"),
